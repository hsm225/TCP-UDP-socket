...
'''
import Tkinter
from udp_server_function import Ucp_Server_Function

class Ucp_Server_Frame_Divide():
    def __init__(self):
        '''
    ...
    def statistical_partion(self, Frame):
        ...
        self.clear_button = Tkinter.Button(statistical_frame, text=u'清空', command=lambda : self.USF.clear_data_text(self.data_text, self.send_num, self.receive_num), width=10)
        self.clear_button.pack(side=Tkinter.RIGHT,padx=5)
        self.log_checkbutton_v = Tkinter.StringVar()
        self.log_checkbutton_v.set(0)
        self.log_checkbutton = Tkinter.Checkbutton(statistical_frame, text=u'日志', variable=self.log_checkbutton_v, command=lambda : self.USF.log_recode(self.log_checkbutton_v, ), width=10)
    ...
    def send_partion_1(self, send_frame):
        ...
        self.send_frame_button_1 = Tkinter.Button(send_frame_1, text=u'发送', command=lambda : self.USF.send_data(self.send_frame_entry_1.get(), self.client_listbox, self.send_num, self.data_text), width=10)
        ...
        self.send_timing_frame_button_1 = Tkinter.Button\
            (send_frame_1, textvariable=self.listen_v_send_timing_1, command=lambda : self.USF.send_data_timing_1(self.listen_v_send_timing_1, self.send_frame_entry_1.get(), self.client_listbox, self.send_timing_frame_entry_1, self.send_num, self.data_text), width=10)
    ...
    def send_partion_2(self, send_frame):
        ...
        self.send_frame_button_2 = Tkinter.Button(send_frame_2, text=u'发送', command=lambda : self.USF.send_data(self.send_frame_entry_2.get(), self.client_listbox, self.send_num, self.data_text), width=10)
        ...
        self.send_timing_frame_button_2 = Tkinter.Button\
            (send_frame_2, textvariable=self.listen_v_send_timing_2, command=lambda : self.USF.send_data_timing_2(self.listen_v_send_timing_2, self.send_frame_entry_2.get(), self.client_listbox, self.send_timing_frame_entry_2, self.send_num, self.data_text), width=10)
    ...
    def send_partion_3(self, send_frame):
        ...
        self.send_frame_button_3 = Tkinter.Button(send_frame_3, text=u'发送', command=lambda : self.USF.send_data(self.send_frame_entry_3.get(), self.client_listbox, self.send_num, self.data_text), width=10)
        ...
        self.send_timing_frame_button_3 = Tkinter.Button\
            (send_frame_3, textvariable=self.listen_v_send_timing_3, command=lambda : self.USF.send_data_timing_3(self.listen_v_send_timing_3, self.send_frame_entry_3.get(), self.client_listbox, self.send_timing_frame_entry_3, self.send_num, self.data_text), width=10)
    ...
    def listen_partion(self, Frame):
        ...
        self.listen_button = Tkinter.Button(server_frame, textvariable=self.listen_v, command=lambda : self.USF.Listen(self.paramater_list()), width=10)
        ...
        self.client_listbox.pack(side=Tkinter.LEFT, fill=Tkinter.X, expand=1, padx=27)
        #self.disconnect_button = Tkinter.Button(client_frame, text=u'断开', command=lambda : self.USF.disconnect_client(self.client_listbox, ), width=10)
