...
'''
import Tkinter
from tcp_client_function import Tcp_Client_Function

class Tcp_Client_Frame_Divide():
    def __init__(self):
        '''
    ...
    def statistical_partion(self, Frame):
        ...
        self.clear_button = Tkinter.Button(statistical_frame, text=u'清空', command=lambda : self.TCF.clear_data_text(self.data_text, self.send_num, self.receive_num), width=10)
        self.clear_button.pack(side=Tkinter.RIGHT,padx=5)
        self.log_checkbutton_v = Tkinter.StringVar()
        self.log_checkbutton_v.set(0)
        self.log_checkbutton = Tkinter.Checkbutton(statistical_frame, text=u'日志', variable=self.log_checkbutton_v, command=lambda : self.TCF.log_recode(self.log_checkbutton_v, ), width=10)
    ...
    def send_partion_1(self, send_frame):
        ...
        self.send_frame_button_1 = Tkinter.Button(send_frame_1, text=u'发送', command=lambda : self.TCF.send_data(self.send_frame_entry_1.get(), self.send_num, self.data_text), width=10)
        ...
        self.send_timing_frame_button_1 = Tkinter.Button\
            (send_frame_1, textvariable=self.listen_v_send_timing_1, command=lambda : self.TCF.send_data_timing_1(self.listen_v_send_timing_1, self.send_frame_entry_1.get(), self.send_timing_frame_entry_1, self.send_num, self.data_text), width=10)
    ...
    def send_partion_2(self, send_frame):
        ...
        self.send_frame_button_2 = Tkinter.Button(send_frame_2, text=u'发送', command=lambda : self.TCF.send_data(self.send_frame_entry_2.get(), self.send_num, self.data_text), width=10)
        ...
        self.send_timing_frame_button_2 = Tkinter.Button\
            (send_frame_2, textvariable=self.listen_v_send_timing_2, command=lambda : self.TCF.send_data_timing_2(self.listen_v_send_timing_2, self.send_frame_entry_2.get(), self.send_timing_frame_entry_2, self.send_num, self.data_text), width=10)
    ...
    def send_partion_3(self, send_frame):
        ...
        self.send_frame_button_3 = Tkinter.Button(send_frame_3, text=u'发送', command=lambda : self.TCF.send_data(self.send_frame_entry_3.get(), self.send_num, self.data_text), width=10)
        ...
        self.send_timing_frame_button_3 = Tkinter.Button\
            (send_frame_3, textvariable=self.listen_v_send_timing_3, command=lambda : self.TCF.send_data_timing_3(self.listen_v_send_timing_3, self.send_frame_entry_3.get(), self.send_timing_frame_entry_3, self.send_num, self.data_text), width=10)
    ...
    def connect_partion(self, Frame):
        ...
        self.connect_v = Tkinter.StringVar()
        self.connect_v.set(u'连接')
        self.connect_button = Tkinter.Button(server_frame, textvariable=self.connect_v, command=lambda : self.TCF.Connect(self.paramater_list()), width=10)
    ...
    def paramater_list(self):
        ...
        return [self.data_text, self.send_num, self.receive_num, self.send_frame_entry_1, self.send_timing_frame_entry_1, self.send_frame_label_2,
                self.send_timing_frame_entry_2, self.send_frame_entry_3, self.send_timing_frame_entry_3, self.ipaddr_server_entry, self.port_server_entry, self.connect_v,
                self.log_checkbutton_v, self.listen_v_send_timing_1, self.listen_v_send_timing_2, self.listen_v_send_timing_3]
